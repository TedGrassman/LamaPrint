...
function writeComment(){
	...
	commentaire=document.getElementById("description").value;
	$.get('/write_comment/'+title[4], {key: commentaire}).done(function() {
		var cookie=getCookie();
		var username= cookie["username"];
		var res=document.getElementById("comment");
		res.innerHTML='</br> <div class="commentaire"><a href="/profile/'+username+'"> User '+ username +"</a>:</br>"+document.getElementById("description").value+'</div>'+res.innerHTML
